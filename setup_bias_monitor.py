...
def main():
    ...
    clarify_output_uri = f"s3://{default_bucket}/pando2/clarify-output"
    
    # Path where the bias monitoring job will output its reports
    monitor_output_path = f"s3://{default_bucket}/pando2/monitoring/bias-reports"
    ...
    bias_monitor.create_monitoring_schedule(
        monitor_schedule_name="pando2-co2-bias-monitor-schedule",
